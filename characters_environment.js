...
function game(){
  ...
  console.log("muñeca derechaX = " + M_derecha_x +" ,muñeca derechaY =  "+ M_derecha_y);
...
function changeGameStatud(character){
 if(M_derecha_x !="" && gameConfig.status==="start" && GameStatus=="start") { 
...
function jumping(character){
	if( (M_derecha_y < 168  &&character.live) || (touchIsDown&&character.live) ){
